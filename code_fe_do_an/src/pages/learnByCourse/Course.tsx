...
export default function Course() {
  return (
    <div className="flex flex-col w-full h-full bg-center bg-cover" style={{backgroundImage: `url("/public/bg2.png")` }}>
      <div className="bg-[#fff8e1]">
        <Header />
      </div>

      <div className="container max-w-[1200px] w-full h-fit p-7">
        <div
          className="bg-white w-full h-full border border-[#78b24d] rounded-2xl"
        >
