...
export default function LearningProcess() {
  ...
  if(widthScreen <= 1400 && widthScreen > 900)
    return (
      <div className="flex items-center justify-center w-full mt-12">
        <div className="flex flex-col w-full h-full gap-3 p-10 bg-white shadow-sm rounded-3xl">
          <div className="mt-5 text-xl font-semibold text-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="flex flex-col items-center justify-around">
              <div className="flex flex-col w-full h-full bg-[#fff8e1] rounded-md shadow-md p-5 gap-3">
                <div className="flex flex-col gap-1">
                  <div className="w-full h-[170px] bg-green-50 rounded-md"></div>
                  <div className="flex flex-row justify-between gap-3">
                    <div className="font-semibold">Tiếng Nhật sơ cấp 1</div>
    ...
    if(widthScreen < 900) return (
      <div className="flex justify-center w-full mt-5 mitems-center">
        <div className="flex flex-col w-3/4 gap-3 p-10 bg-white shadow-sm h-3/5 rounded-3xl">
          <div className="mt-5 text-xl font-semibold text-center">
            TIẾN ĐỘ HỌC TẬP
          </div>
