...
const INVALID_NOTI_TYPE = "Loại lấy thông báo không hợp lệ";
...
const ID_GUARD = "ID bình luận phải là số";
const IDS_GUARD = "Danh sách ID bình luận không được rỗng";
const TARGET_ID_GUARD = "ID mục tiêu phải là số";
const SOURCE_ID_GUARD = "ID nguồn phải là số";
const READ_GUARD = "'is_read' phải là kiểu boolean";
const NOTI_DATE_GUARD = "'noti_date' phải ở định dạng 'yyyy-MM-dd'";
