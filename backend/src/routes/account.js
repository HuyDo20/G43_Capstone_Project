...
const { registerAccount,createUser, getListUser, updateUserById, deleteUserById, getUserById, loginAccount, verifyOtpThenCreateNewAccount, verifyOtp,resendOtp, changePassword } =
...
router.put("/account/:account_id/change-password", changePassword);
